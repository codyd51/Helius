...
//#define DEFAULT_CROSSFADE_DURATION 0.9
//#define DEFAULT_CROSSFADE_DURATION crossfadeDuration
...
- (void)setArtworkImage:(UIImage *)artworkImage {
    ...
    [self setZoomFactor:DEFAULT_BLUR_ZOOM andStyle:DEFAULT_BLUR_STYLE andDuration:crossfadeDuration forImage:_artworkImage];
}
...
- (void)setZoomFactor:(float)zoomFactor andStyle:(int)style andDuration:(int)duration forImage:(UIImage *)image {
    // On Styles...
    //
    // 0 No blur
    // 1 No blur
    ...
    //NSMutableDictionary* prefs = [NSMutableDictionary dictionaryWithContentsOfFile:[NSHomeDirectory() stringByAppendingPathComponent:@"/Library/Preferences/com.phillipt.musictest.plist"]];

    //int crossfadeDuration;
    //if ([[prefs objectForKey:@"crossfadeDuration"] intValue] == nil) crossfadeDuration = 1;
